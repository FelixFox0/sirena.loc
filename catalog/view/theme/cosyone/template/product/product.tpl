  ...
  <div class="product-page _top">
    ...
    <div class="container">
      <div class="product-page__container">
          <div class="prod-slider col-md-6">

              <div class="item">
                  <div>

                      <ul id="prod-top-slider" class="prod-top-slider">
                        
                            <li data-thumb="<?php echo $thumb; ?>" data-src="<?php echo $popup_orig; ?>">
                                <a href="<?php // echo $href; ?>#product_top">
                                    <span data-src="<?php echo $popup_orig; ?>">
                                        <img itemprop="image" src="<?php echo $popup_orig; ?>" title="<?php echo $heading_title; ?>" alt="<?php echo $meta_title; ?>" />
                                    </span>
                                </a>
                            </li>
                          ...
                          <li data-thumb="<?php echo $image['thumb']; ?>">
                              ...
                              <a href="<?php echo '#product' . $key; ?>">
                                  <span data-src="<?php echo $image['popup_orig']; ?>">

                                      <img src="<?php echo $image['popup_orig']; ?>" alt="<?php echo $meta_title; ?>" />
      ...
      <div class="product-page__info__fix col-md-6">
      ...
      <?php } ?> 
                ...
                <div class="icons_wrapper">
                    <span class="stockk">
                        <span class=" <?php if ($data_qty > 0) {echo "in_stock"; } ?>"><i class="fa fa-check wishlistTrigger" aria-hidden="true"></i><?php echo $stock; ?></span>
                ...
                <!--<div class="prod-other-colors">
                    <div class="title">другие доступные цвета:</div>
                    <div class="colors">
                        <div></div>
                        <div></div>
                        <div></div>
...
<script>
    $(document).ready(function() {
        $('#prod-top-slider a').click(function(e){
            e.preventDefault();
        })
    })
</script>

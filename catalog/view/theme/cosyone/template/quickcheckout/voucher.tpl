...
<div id="coupon-content" class="required">
	<input type="text" name="coupon" value="" placeholder="<?php echo $entry_coupon; ?>" class="col-md-5"/>
	<button type="button" id="button-coupon" class="button col-md-4"><?php echo $text_use_coupon; ?></button>
</div>
<?php } ?>

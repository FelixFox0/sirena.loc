      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="basket">
    	...
    	<div class="cart-info">
          <table class="contrast_font cart-top">
            <?php foreach ($products as $product) { ?> <thead>
             <tr>
            ...
            <tbody>
              ...
              <tr>
                <td class="image mobile_hide"><?php if ($product['thumb']) { ?>
                  ...
                  <?php } ?></td>
                <td class="name">
                  <p class="cart-articul-text"><?php echo $text_articul_name; ?> <?php echo $product['model']; ?></p>
                  <a onclick="cart.remove('<?php echo $product['cart_id']; ?>');" data-tooltip="<?php echo $button_remove; ?>" class="sq_icon cart-product-delete"><?php echo $cart_product_delete; ?></a>
            ...
            <td class="name"><?php echo $vouchers['description']; ?>
              <a class="remove_link up_to_mobile" onclick="voucher.remove('<?php echo $vouchers['key']; ?>');" title="<?php echo $button_remove; ?>">[<?php echo $button_remove; ?>]</a>
            </td>

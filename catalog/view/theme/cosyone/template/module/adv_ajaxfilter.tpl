                        ...
                        <div class="collapsible filters" <?php if(!$attribute_value['expanded']){echo '';}?>>
                            ...
                            <table style="width:100%">
                                <tr>
                                    ...
                                    <td><span id="attribute_label_<?php echo $attribute_value_id; ?>_max"><?php echo $attribute_value['values'][count($attribute_value['values'])-1].' '.$attribute_value['suffix']; ?></span>

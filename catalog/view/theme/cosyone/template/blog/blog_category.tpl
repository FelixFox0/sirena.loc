...
<div class="container">
  	...
  	<?php if($blogs){ ?>
		...
		<div class="blog_item">
				...
				<a href="<?php echo $blog['href']; ?>">
                    <img src="<?php echo $blog['image']; ?>" class="zoom_image" alt="<?php echo $blog['title']; ?>" title="<?php echo $blog['title']; ?>" />
                </a>
                </div>
				<?php } ?>
 ...
 <!-- blog-stats ends -->
            ...
            <div class="more-news">
                <p><a href="<?php echo $blog['href']; ?>" class="blog-cat-read-more"><?php echo $text_read_more; ?><i class="fa fa-chevron-right"></i></a></p>
            </div>
              </div> <!-- item ends -->

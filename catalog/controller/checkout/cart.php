...
class ControllerCheckoutCart extends Controller {
	public function index() {
		...
		if ($this->cart->hasProducts() || !empty($this->session->data['vouchers'])) {
                    $this->response->redirect($this->url->link('checkout/checkout', '', false, $this->session->data['country_code'], $this->session->data['language_name']));
			$data['heading_title'] = $this->language->get('heading_title');
			$data['text_articul_name'] = $this->language->get('text_articul_name');
			$data['cart_product_delete'] = $this->language->get('cart_product_delete');

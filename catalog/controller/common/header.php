...
//            die();
            $data['language_name'] = $this->session->data['language_name'];
//            var_dump($this->url->link('product/category', '', false, $this->session->data['country_code'], $this->session->data['language_name']));
		...
		$data['text_all'] = $this->language->get('text_all');
                ...
                $data['text_popup_btn'] = $this->language->get('text_popup_btn');
...
//                var_dump($data['countries_array']);
                ...
                $data['country_name'] = $this->model_startup_url->checkCountryIso($this->session->data['country_code'])['name'];

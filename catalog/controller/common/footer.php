...
class ControllerCommonFooter extends Controller {
	public function index() {
		...
		$data['text_newsletter'] = $this->language->get('text_newsletter');
                ...
                $data['text_order_history'] = $this->language->get('text_'.$country.'_phone');
                $data['text_order_status'] = $this->language->get('text_'.$country.'_phone');
                $data['text_order_wish'] = $this->language->get('text_'.$country.'_phone');

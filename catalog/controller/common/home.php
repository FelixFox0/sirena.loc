...
//            die();
		...
		if (isset($this->request->get['route'])) {
			$this->document->addLink(HTTP_SERVER, 'canonical');
                ...
                $data['text_bags_t'] = $this->language->get('text_bags_t');
                $data['text_shoes_t'] = $this->language->get('text_shoes_t');
                $data['text_acsess_t'] = $this->language->get('text_acsess_t');
                $data['text_inst_t'] = $this->language->get('text_inst_t');
                $data['text_bags_ht1'] = $this->language->get('text_bags_ht1');
                $data['text_bags_ht2'] = $this->language->get('text_bags_ht2');
                $data['text_shoes_ht1'] = $this->language->get('text_shoes_ht1');
                $data['text_shoes_ht2'] = $this->language->get('text_shoes_ht2');
                $data['text_acsess_ht'] = $this->language->get('text_acsess_ht');

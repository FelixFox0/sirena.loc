...
class ControllerQuickCheckoutCheckout extends Controller { 
	public function index() {
	    ...
	    $data['more_buy_btn'] = $this->language->get('more_buy_btn');

		$data['text_checkout_option'] = $this->language->get('text_checkout_option');
		$data['text_checkout_account'] = $this->language->get('text_checkout_account');
		$data['text_checkout_adress_text'] = $this->language->get('text_checkout_adress_text');
		$data['text_checkout_pay_text'] = $this->language->get('text_checkout_pay_text');
		$data['text_checkout_deliv_text'] = $this->language->get('text_checkout_deliv_text');
